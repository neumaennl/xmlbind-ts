...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <xsd:element name="Record" type="Record"/>
        ...
        withTmpDir((tmp) => {
          ...
          expect(content).toContain("import { StatusEnum } from './enums.js'");
  ...
  <xsd:element name="UsesRestricted" type="UsesRestricted"/>
        ...
        withTmpDir((tmp) => {
          ...
          expect(content).toContain(
            "import type { RestrictedString } from './types.js'"
          );
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
  ...
  <xsd:element name="Item" type="Item"/>
      ...
      withTmpDir((tmp) => {
        ...
        if (fieldMatch) {
          // eslint-disable-next-line vitest/no-conditional-expect -- Conditional expect needed to validate regex match result before accessing it
