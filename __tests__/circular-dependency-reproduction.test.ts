...
import { XmlRoot, XmlElement, unmarshal, marshal } from "../src/index.js";
import { getAllFields } from "../src/metadata/MetadataRegistry.js";
...
describe("Circular Dependency Bug Reproduction", () => {
  ...
  describe("Generated code uses lazy type references", () => {
    test("generator emits lazy type references for non-primitive types", async () => {
      const { generateFromXsd } = await import("../src/xsd/TsGenerator.js");
