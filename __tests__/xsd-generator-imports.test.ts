...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  <xsd:complexType name="Person">
    ...
    withTmpDir((tmp) => {
      ...
      expect(personFile).toContain("import { Address } from './Address.js';");
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  <xsd:complexType name="Company">
    ...
    withTmpDir((tmp) => {
      ...
      expect(deptFile).toContain("import { Email } from './Email.js';");
      expect(deptFile).toContain("import { Phone } from './Phone.js';");
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  expect(messageTypeFile).toContain("import { Status } from './Status.js';");
...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema"
  ...
  <xsd:complexType name="Customer">
    ...
    withTmpDir((tmp) => {
      ...
      expect(orderFile).toContain("import { Customer } from './Customer.js';");
      ...
      expect(customerFile).toContain("import { Order } from './Order.js';");
